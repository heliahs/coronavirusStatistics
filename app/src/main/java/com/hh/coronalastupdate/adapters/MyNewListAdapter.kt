...
class MyNewListAdapter  (val clickListener: MyAdapterDataListener) : ListAdapter<Country, MyNewListAdapter.ViewHolder>(SleepNightDiffCallback()) {
...
class SleepNightDiffCallback : DiffUtil.ItemCallback<Country>() {
